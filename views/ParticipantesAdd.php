...
// Page object
$ParticipantesAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fparticipantesadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fparticipantesadd = currentForm = new ew.Form("fparticipantesadd", "add");
    ...
    // Validate form
    fparticipantesadd.validate = function () {
    ...
    // Form_CustomValidate
    fparticipantesadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fparticipantesadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fparticipantesadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fparticipantesadd" id="fparticipantesadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
