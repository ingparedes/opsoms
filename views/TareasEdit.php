...
$Page->showMessage();
?>
<form name="ftareasedit" id="ftareasedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<?php if ($Page->id_tarea->Visible) { // id_tarea ?>
    <div id="r_id_tarea" class="form-group row">
        <label id="elh_tareas_id_tarea" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_tarea->caption() ?><?= $Page->id_tarea->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<script>
loadjs.ready(["ftareasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftareasedit", "x_fechainireal_tarea", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftareasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftareasedit", "x_fechafin_tarea", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftareasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftareasedit", "x_fechainisimulado_tarea", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["ftareasedit", "datetimepicker"], function() {
    ew.createDateTimePicker("ftareasedit", "x_fechafinsimulado_tarea", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
