...
loadjs.ready("head", function () {
    ...
    fincidenteadd = currentForm = new ew.Form("fincidenteadd", "add");
    ...
    // Validate form
    fincidenteadd.validate = function () {
    ...
    // Form_CustomValidate
    fincidenteadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fincidenteadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fincidenteadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fincidenteadd" id="fincidenteadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
