...
// Page object
$ActorSimuladoAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var factor_simuladoadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    factor_simuladoadd = currentForm = new ew.Form("factor_simuladoadd", "add");
    ...
    // Validate form
    factor_simuladoadd.validate = function () {
    ...
    // Form_CustomValidate
    factor_simuladoadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    factor_simuladoadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("factor_simuladoadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="factor_simuladoadd" id="factor_simuladoadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
