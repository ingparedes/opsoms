...
// Page object
$MensajesUsuariosAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fmensajes_usuariosadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fmensajes_usuariosadd = currentForm = new ew.Form("fmensajes_usuariosadd", "add");
    ...
    fmensajes_usuariosadd.addFields([
    ...
    // Validate form
    fmensajes_usuariosadd.validate = function () {
    ...
    // Form_CustomValidate
    fmensajes_usuariosadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fmensajes_usuariosadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fmensajes_usuariosadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fmensajes_usuariosadd" id="fmensajes_usuariosadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
