...
loadjs.ready("head", function () {
    ...
    fpaisgmtadd = currentForm = new ew.Form("fpaisgmtadd", "add");
    ...
    // Form_CustomValidate
    fpaisgmtadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fpaisgmtadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fpaisgmtadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fpaisgmtadd" id="fpaisgmtadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
