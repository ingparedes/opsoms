...
$Page->showMessage();
?>
<form name="fmensajesedit" id="fmensajesedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl() ?>" method="post">
...
<script>
loadjs.ready(["fmensajesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmensajesedit", "x_fechareal_start", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fmensajesedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fmensajesedit", "x_fechasim_start", {"ignoreReadonly":true,"useCurrent":false,"format":109});
});
</script>
<?php } ?>
</span>
