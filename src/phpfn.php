...
function SetupLoginStatus()
{
    ...
    if ($currentPage != $changePasswordPage) {
        ...
        if (!IsMobile()) {
            $changePasswordUrl = "return ew.modalDialogShow({lnk:this,btn:'ChangePassword',caption:ew.language.phrase('ChangePassword'),size:'',url:'" . HtmlEncode(GetUrl($changePasswordPage)) . "'});";
        }
    }
