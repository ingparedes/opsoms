...
$LANGUAGES = [["en","","english.xml"],["es","","Spanish.xml"]];
...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'sYxH66ZexmGtUn4n', // Random key for encryption
    ...
    "ADMIN_USER_NAME" => "maestro", // Administrator user name
    "ADMIN_PASSWORD" => "simex", // Administrator password
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,ppt,pptx", // Allowed file extensions
