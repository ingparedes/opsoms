 ...
 * Page class
 */
class TareasList extends Tareas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TareasList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "ftareaslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "TareasAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "TareasDelete";
        $this->MultiUpdateUrl = "TareasUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option ftareaslistsrch";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->id_tarea->AdvancedSearch->toJson(), ","); // Field id_tarea
        ...
        $filterList = Concat($filterList, $this->titulo_tarea->AdvancedSearch->toJson(), ","); // Field titulo_tarea
        $filterList = Concat($filterList, $this->descripcion_tarea->AdvancedSearch->toJson(), ","); // Field descripcion_tarea
        $filterList = Concat($filterList, $this->fechainireal_tarea->AdvancedSearch->toJson(), ","); // Field fechainireal_tarea
        $filterList = Concat($filterList, $this->fechafin_tarea->AdvancedSearch->toJson(), ","); // Field fechafin_tarea
        $filterList = Concat($filterList, $this->fechainisimulado_tarea->AdvancedSearch->toJson(), ","); // Field fechainisimulado_tarea
        $filterList = Concat($filterList, $this->fechafinsimulado_tarea->AdvancedSearch->toJson(), ","); // Field fechafinsimulado_tarea
        $filterList = Concat($filterList, $this->id_tarearelacion->AdvancedSearch->toJson(), ","); // Field id_tarearelacion
        $filterList = Concat($filterList, $this->archivo->AdvancedSearch->toJson(), ","); // Field archivo
        $filterList = Concat($filterList, $this->id_subgrupo->AdvancedSearch->toJson(), ","); // Field id_subgrupo
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "ftareaslistsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field id_tarea
        $this->id_tarea->AdvancedSearch->SearchValue = @$filter["x_id_tarea"];
        $this->id_tarea->AdvancedSearch->SearchOperator = @$filter["z_id_tarea"];
        $this->id_tarea->AdvancedSearch->SearchCondition = @$filter["v_id_tarea"];
        $this->id_tarea->AdvancedSearch->SearchValue2 = @$filter["y_id_tarea"];
        $this->id_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_id_tarea"];
        $this->id_tarea->AdvancedSearch->save();
        ...
        // Field titulo_tarea
        $this->titulo_tarea->AdvancedSearch->SearchValue = @$filter["x_titulo_tarea"];
        $this->titulo_tarea->AdvancedSearch->SearchOperator = @$filter["z_titulo_tarea"];
        $this->titulo_tarea->AdvancedSearch->SearchCondition = @$filter["v_titulo_tarea"];
        $this->titulo_tarea->AdvancedSearch->SearchValue2 = @$filter["y_titulo_tarea"];
        $this->titulo_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_titulo_tarea"];
        $this->titulo_tarea->AdvancedSearch->save();

        // Field descripcion_tarea
        $this->descripcion_tarea->AdvancedSearch->SearchValue = @$filter["x_descripcion_tarea"];
        $this->descripcion_tarea->AdvancedSearch->SearchOperator = @$filter["z_descripcion_tarea"];
        $this->descripcion_tarea->AdvancedSearch->SearchCondition = @$filter["v_descripcion_tarea"];
        $this->descripcion_tarea->AdvancedSearch->SearchValue2 = @$filter["y_descripcion_tarea"];
        $this->descripcion_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_descripcion_tarea"];
        $this->descripcion_tarea->AdvancedSearch->save();

        // Field fechainireal_tarea
        $this->fechainireal_tarea->AdvancedSearch->SearchValue = @$filter["x_fechainireal_tarea"];
        $this->fechainireal_tarea->AdvancedSearch->SearchOperator = @$filter["z_fechainireal_tarea"];
        $this->fechainireal_tarea->AdvancedSearch->SearchCondition = @$filter["v_fechainireal_tarea"];
        $this->fechainireal_tarea->AdvancedSearch->SearchValue2 = @$filter["y_fechainireal_tarea"];
        $this->fechainireal_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_fechainireal_tarea"];
        $this->fechainireal_tarea->AdvancedSearch->save();

        // Field fechafin_tarea
        $this->fechafin_tarea->AdvancedSearch->SearchValue = @$filter["x_fechafin_tarea"];
        $this->fechafin_tarea->AdvancedSearch->SearchOperator = @$filter["z_fechafin_tarea"];
        $this->fechafin_tarea->AdvancedSearch->SearchCondition = @$filter["v_fechafin_tarea"];
        $this->fechafin_tarea->AdvancedSearch->SearchValue2 = @$filter["y_fechafin_tarea"];
        $this->fechafin_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_fechafin_tarea"];
        $this->fechafin_tarea->AdvancedSearch->save();

        // Field fechainisimulado_tarea
        $this->fechainisimulado_tarea->AdvancedSearch->SearchValue = @$filter["x_fechainisimulado_tarea"];
        $this->fechainisimulado_tarea->AdvancedSearch->SearchOperator = @$filter["z_fechainisimulado_tarea"];
        $this->fechainisimulado_tarea->AdvancedSearch->SearchCondition = @$filter["v_fechainisimulado_tarea"];
        $this->fechainisimulado_tarea->AdvancedSearch->SearchValue2 = @$filter["y_fechainisimulado_tarea"];
        $this->fechainisimulado_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_fechainisimulado_tarea"];
        $this->fechainisimulado_tarea->AdvancedSearch->save();

        // Field fechafinsimulado_tarea
        $this->fechafinsimulado_tarea->AdvancedSearch->SearchValue = @$filter["x_fechafinsimulado_tarea"];
        $this->fechafinsimulado_tarea->AdvancedSearch->SearchOperator = @$filter["z_fechafinsimulado_tarea"];
        $this->fechafinsimulado_tarea->AdvancedSearch->SearchCondition = @$filter["v_fechafinsimulado_tarea"];
        $this->fechafinsimulado_tarea->AdvancedSearch->SearchValue2 = @$filter["y_fechafinsimulado_tarea"];
        $this->fechafinsimulado_tarea->AdvancedSearch->SearchOperator2 = @$filter["w_fechafinsimulado_tarea"];
        $this->fechafinsimulado_tarea->AdvancedSearch->save();

        // Field id_tarearelacion
        $this->id_tarearelacion->AdvancedSearch->SearchValue = @$filter["x_id_tarearelacion"];
        $this->id_tarearelacion->AdvancedSearch->SearchOperator = @$filter["z_id_tarearelacion"];
        $this->id_tarearelacion->AdvancedSearch->SearchCondition = @$filter["v_id_tarearelacion"];
        $this->id_tarearelacion->AdvancedSearch->SearchValue2 = @$filter["y_id_tarearelacion"];
        $this->id_tarearelacion->AdvancedSearch->SearchOperator2 = @$filter["w_id_tarearelacion"];
        $this->id_tarearelacion->AdvancedSearch->save();
        ...
        // Field id_subgrupo
        $this->id_subgrupo->AdvancedSearch->SearchValue = @$filter["x_id_subgrupo"];
        $this->id_subgrupo->AdvancedSearch->SearchOperator = @$filter["z_id_subgrupo"];
        $this->id_subgrupo->AdvancedSearch->SearchCondition = @$filter["v_id_subgrupo"];
        $this->id_subgrupo->AdvancedSearch->SearchValue2 = @$filter["y_id_subgrupo"];
        $this->id_subgrupo->AdvancedSearch->SearchOperator2 = @$filter["w_id_subgrupo"];
        $this->id_subgrupo->AdvancedSearch->save();
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->id_tarea, $default, false); // id_tarea
        $this->buildSearchSql($where, $this->id_escenario, $default, false); // id_escenario
        $this->buildSearchSql($where, $this->id_grupo, $default, false); // id_grupo
        $this->buildSearchSql($where, $this->titulo_tarea, $default, false); // titulo_tarea
        $this->buildSearchSql($where, $this->descripcion_tarea, $default, false); // descripcion_tarea
        $this->buildSearchSql($where, $this->fechainireal_tarea, $default, false); // fechainireal_tarea
        $this->buildSearchSql($where, $this->fechafin_tarea, $default, false); // fechafin_tarea
        $this->buildSearchSql($where, $this->fechainisimulado_tarea, $default, false); // fechainisimulado_tarea
        $this->buildSearchSql($where, $this->fechafinsimulado_tarea, $default, false); // fechafinsimulado_tarea
        $this->buildSearchSql($where, $this->id_tarearelacion, $default, false); // id_tarearelacion
        $this->buildSearchSql($where, $this->archivo, $default, false); // archivo
        $this->buildSearchSql($where, $this->id_subgrupo, $default, false); // id_subgrupo
        ...
        if (!$default && $this->Command == "search") {
            $this->id_tarea->AdvancedSearch->save(); // id_tarea
            $this->id_escenario->AdvancedSearch->save(); // id_escenario
            $this->id_grupo->AdvancedSearch->save(); // id_grupo
            $this->titulo_tarea->AdvancedSearch->save(); // titulo_tarea
            $this->descripcion_tarea->AdvancedSearch->save(); // descripcion_tarea
            $this->fechainireal_tarea->AdvancedSearch->save(); // fechainireal_tarea
            $this->fechafin_tarea->AdvancedSearch->save(); // fechafin_tarea
            $this->fechainisimulado_tarea->AdvancedSearch->save(); // fechainisimulado_tarea
            $this->fechafinsimulado_tarea->AdvancedSearch->save(); // fechafinsimulado_tarea
            $this->id_tarearelacion->AdvancedSearch->save(); // id_tarearelacion
            $this->archivo->AdvancedSearch->save(); // archivo
            $this->id_subgrupo->AdvancedSearch->save(); // id_subgrupo
        }
        return $where;
    }
    ...
    {
        $where = "";
        $this->buildBasicSearchSql($where, $this->id_grupo, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->titulo_tarea, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->descripcion_tarea, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->archivo, $arKeywords, $type);
        return $where;
    }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->id_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->id_escenario->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->id_grupo->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->titulo_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->descripcion_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fechainireal_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fechafin_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fechainisimulado_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fechafinsimulado_tarea->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->id_tarearelacion->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->archivo->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->id_subgrupo->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
                $this->id_tarea->AdvancedSearch->unsetSession();
                $this->id_escenario->AdvancedSearch->unsetSession();
                $this->id_grupo->AdvancedSearch->unsetSession();
                $this->titulo_tarea->AdvancedSearch->unsetSession();
                $this->descripcion_tarea->AdvancedSearch->unsetSession();
                $this->fechainireal_tarea->AdvancedSearch->unsetSession();
                $this->fechafin_tarea->AdvancedSearch->unsetSession();
                $this->fechainisimulado_tarea->AdvancedSearch->unsetSession();
                $this->fechafinsimulado_tarea->AdvancedSearch->unsetSession();
                $this->id_tarearelacion->AdvancedSearch->unsetSession();
                $this->archivo->AdvancedSearch->unsetSession();
                $this->id_subgrupo->AdvancedSearch->unsetSession();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->fechafin_tarea); // fechafin_tarea
            $this->updateSort($this->fechainisimulado_tarea); // fechainisimulado_tarea
            $this->updateSort($this->fechafinsimulado_tarea); // fechafinsimulado_tarea
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_tarea->setSort("");
                $this->id_escenario->setSort("");
                $this->id_grupo->setSort("");
                $this->titulo_tarea->setSort("");
                $this->descripcion_tarea->setSort("");
                $this->fechainireal_tarea->setSort("");
                $this->fechafin_tarea->setSort("");
                $this->fechainisimulado_tarea->setSort("");
                $this->fechafinsimulado_tarea->setSort("");
                $this->id_tarearelacion->setSort("");
                $this->archivo->setSort("");
                $this->id_subgrupo->setSort("");
            }
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_mensajes"
        $item = &$this->ListOptions->add("detail_mensajes");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'mensajes') && !$this->ShowMultipleDetails;
        $item->OnLeft = false;
    ...
    public function renderListOptions()
    {
        ...
        // "detail_mensajes"
        $opt = $this->ListOptions["detail_mensajes"];
        if ($Security->allowList(CurrentProjectID() . 'mensajes')) {
            $body = $Language->phrase("DetailLink") . $Language->TablePhrase("mensajes", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode("MensajesList?" . Config("TABLE_SHOW_MASTER") . "=tareas&" . GetForeignKeyUrl("fk_id_tarea", $this->id_tarea->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("MensajesGrid");
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'tareas')) {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_tarea->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $detailTableLink = "";
                $item = &$option->add("detailadd_mensajes");
                $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=mensajes");
                $detailPage = Container("MensajesGrid");
                $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
                $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
                $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'tareas') && $Security->canAdd());
                if ($item->Visible) {
                    if ($detailTableLink != "") {
                        $detailTableLink .= ",";
                    }
                    $detailTableLink .= "mensajes";
                }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"ftareaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"ftareaslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.ftareaslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        // id_tarea
        if (!$this->isAddOrEdit() && $this->id_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->id_tarea->AdvancedSearch->SearchValue != "" || $this->id_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // id_grupo
        if (!$this->isAddOrEdit() && $this->id_grupo->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->id_grupo->AdvancedSearch->SearchValue != "" || $this->id_grupo->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // titulo_tarea
        if (!$this->isAddOrEdit() && $this->titulo_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->titulo_tarea->AdvancedSearch->SearchValue != "" || $this->titulo_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // descripcion_tarea
        if (!$this->isAddOrEdit() && $this->descripcion_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->descripcion_tarea->AdvancedSearch->SearchValue != "" || $this->descripcion_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // fechainireal_tarea
        if (!$this->isAddOrEdit() && $this->fechainireal_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fechainireal_tarea->AdvancedSearch->SearchValue != "" || $this->fechainireal_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // fechafin_tarea
        if (!$this->isAddOrEdit() && $this->fechafin_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fechafin_tarea->AdvancedSearch->SearchValue != "" || $this->fechafin_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // fechainisimulado_tarea
        if (!$this->isAddOrEdit() && $this->fechainisimulado_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fechainisimulado_tarea->AdvancedSearch->SearchValue != "" || $this->fechainisimulado_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // fechafinsimulado_tarea
        if (!$this->isAddOrEdit() && $this->fechafinsimulado_tarea->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fechafinsimulado_tarea->AdvancedSearch->SearchValue != "" || $this->fechafinsimulado_tarea->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // id_tarearelacion
        if (!$this->isAddOrEdit() && $this->id_tarearelacion->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->id_tarearelacion->AdvancedSearch->SearchValue != "" || $this->id_tarearelacion->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // archivo
        if (!$this->isAddOrEdit() && $this->archivo->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->archivo->AdvancedSearch->SearchValue != "" || $this->archivo->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // id_subgrupo
        if (!$this->isAddOrEdit() && $this->id_subgrupo->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->id_subgrupo->AdvancedSearch->SearchValue != "" || $this->id_subgrupo->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" onclick=\"return ew.export(document.ftareaslist, '" . $this->ExportExcelUrl . "', 'excel', true);\">" . $Language->phrase("ExportToExcel") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportExcelUrl . "\" class=\"ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcelText")) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" onclick=\"return ew.export(document.ftareaslist, '" . $this->ExportWordUrl . "', 'word', true);\">" . $Language->phrase("ExportToWord") . "</a>";
            } else {
                return "<a href=\"" . $this->ExportWordUrl . "\" class=\"ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWordText")) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<a href=\"#\" class=\"ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPDFText")) . "\" onclick=\"return ew.export(document.ftareaslist, '" . $this->ExportPdfUrl . "', 'pdf', true);\">" . $Language->phrase("ExportToPDF") . "</a>";
            } else {
            ...
            return '<button id="emf_tareas" class="ew-export-link ew-email" title="' . $Language->phrase("ExportToEmailText") . '" data-caption="' . $Language->phrase("ExportToEmailText") . '" onclick="ew.emailDialogShow({lnk:\'emf_tareas\', hdr:ew.language.phrase(\'ExportToEmailText\'), f:document.ftareaslist, sel:false' . $url . '});">' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchSortOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ftareaslistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
