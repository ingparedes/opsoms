 ...
 * Page class
 */
class MensajesDelete extends Mensajes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MensajesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MensajesList"); // Return to list
                return;
            }
        }
