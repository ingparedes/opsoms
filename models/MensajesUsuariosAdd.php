 ...
 * Page class
 */
class MensajesUsuariosAdd extends MensajesUsuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesUsuariosAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "MensajesUsuariosView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_mensaje_usuario->OldValue = $this->id_mensaje_usuario->CurrentValue;
        $this->id_user_remitente->CurrentValue = null;
        $this->id_user_remitente->OldValue = $this->id_user_remitente->CurrentValue;
        $this->id_user_destinatario->CurrentValue = null;
        $this->id_user_destinatario->OldValue = $this->id_user_destinatario->CurrentValue;
        $this->id_mensaje->CurrentValue = null;
        $this->id_mensaje->OldValue = $this->id_mensaje->CurrentValue;
    }
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_mensaje_usuario'] = $this->id_mensaje_usuario->CurrentValue;
        $row['id_user_remitente'] = $this->id_user_remitente->CurrentValue;
        $row['id_user_destinatario'] = $this->id_user_destinatario->CurrentValue;
        $row['id_mensaje'] = $this->id_mensaje->CurrentValue;
        return $row;
    }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // id_user_remitente
        $this->id_user_remitente->setDbValueDef($rsnew, $this->id_user_remitente->CurrentValue, null, false);

        // id_user_destinatario
        $this->id_user_destinatario->setDbValueDef($rsnew, $this->id_user_destinatario->CurrentValue, null, false);
