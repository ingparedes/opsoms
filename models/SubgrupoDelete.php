 ...
 * Page class
 */
class SubgrupoDelete extends Subgrupo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubgrupoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("SubgrupoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("SubgrupoList"); // Return to list
                return;
            }
        }
