...
class MensajesAdd extends Mensajes
{
    ...
    protected function addRow($rsold = null)
    {
        ...
        if (strval($this->id_tareas->CurrentValue) != "") {
            $masterFilter = str_replace("@id_tarea@", AdjustSql($this->id_tareas->CurrentValue, "DB"), $masterFilter);
        } else {
        ...
        // id_tareas
        $this->id_tareas->setDbValueDef($rsnew, $this->id_tareas->CurrentValue, null, false);
