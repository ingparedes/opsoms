 ...
 * Page class
 */
class MensajesUsuariosView extends MensajesUsuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesUsuariosView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_mensaje_usuario") ?? Route("id_mensaje_usuario")) !== null) {
            $this->RecKey["id_mensaje_usuario"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_mensaje_usuario") ?? Route("id_mensaje_usuario")) !== null) {
                ...
                $this->RecKey["id_mensaje_usuario"] = $this->id_mensaje_usuario->QueryStringValue;
            } elseif (Post("id_mensaje_usuario") !== null) {
                $this->id_mensaje_usuario->setFormValue(Post("id_mensaje_usuario"));
                $this->RecKey["id_mensaje_usuario"] = $this->id_mensaje_usuario->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_mensaje_usuario->setQueryStringValue($keyValue);
                $this->RecKey["id_mensaje_usuario"] = $this->id_mensaje_usuario->QueryStringValue;
            } else {
                $returnUrl = "MensajesUsuariosList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MensajesUsuariosList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MensajesUsuariosList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
