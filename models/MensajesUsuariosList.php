 ...
 * Page class
 */
class MensajesUsuariosList extends MensajesUsuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesUsuariosList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fmensajes_usuarioslist";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "MensajesUsuariosAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "MensajesUsuariosDelete";
        $this->MultiUpdateUrl = "MensajesUsuariosUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fmensajes_usuarioslistsrch";
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_mensaje_usuario); // id_mensaje_usuario
            $this->updateSort($this->id_user_remitente); // id_user_remitente
            $this->updateSort($this->id_user_destinatario); // id_user_destinatario
            $this->updateSort($this->id_mensaje); // id_mensaje
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                $orderBy = "";
                $this->setSessionOrderBy($orderBy);
                $this->id_mensaje_usuario->setSort("");
                $this->id_user_remitente->setSort("");
                $this->id_user_destinatario->setSort("");
                $this->id_mensaje->setSort("");
            }
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->id_mensaje_usuario->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fmensajes_usuarioslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fmensajes_usuarioslistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fmensajes_usuarioslist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
