 ...
 * Page class
 */
class ParticipantesAdd extends Participantes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ParticipantesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ParticipantesView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->id_participantes->OldValue = $this->id_participantes->CurrentValue;
        ...
        $this->imagen_participante->CurrentValue = null;
        $this->imagen_participante->OldValue = $this->imagen_participante->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row = [];
        $row['id_participantes'] = $this->id_participantes->CurrentValue;
        ...
        $row['imagen_participante'] = $this->imagen_participante->CurrentValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        // subgrupo
        $this->subgrupo->setDbValueDef($rsnew, $this->subgrupo->CurrentValue, null, false);

        // imagen_participante
        $this->imagen_participante->setDbValueDef($rsnew, $this->imagen_participante->CurrentValue, null, false);
