 ...
 * Page class
 */
class TareasPreview extends Tareas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TareasPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "escenario") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=escenario&" . GetForeignKeyUrl("fk_id_escenario", $this->id_escenario->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "escenario") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_escenario->setQueryStringValue($val);
            }
        }
    }
