 ...
 * Page class
 */
class MensajesUsuariosDelete extends MensajesUsuarios
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesUsuariosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MensajesUsuariosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MensajesUsuariosList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        if ($deleteRows) {
            ...
            foreach ($rsold as $row) {
                ...
                $thisKey .= $row['id_mensaje_usuario'];
