 ...
 * Page class
 */
class ArchivosDocDelete extends ArchivosDoc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ArchivosDocDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ArchivosDocList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ArchivosDocList"); // Return to list
                return;
            }
        }
