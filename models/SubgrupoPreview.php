 ...
 * Page class
 */
class SubgrupoPreview extends Subgrupo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "SubgrupoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "grupo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=grupo&" . GetForeignKeyUrl("fk_id_grupo", $this->id_grupo->QueryStringValue) . "";
        }
        return $url;
    }
