...
class Historico
{
    ...
    // Table name
    public $TableName = 'historico.php';

    // Page object name
    public $PageObjName = "Historico";
    ...
    public function __construct()
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'historico.php');
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $Breadcrumb->add("custom", "historico", CurrentUrl(), "", "historico", true);
        $this->Heading = $Language->TablePhrase("historico", "TblCaption");
    }
