 ...
 * Page class
 */
class Email2Delete extends Email2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Email2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Email2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Email2List"); // Return to list
                return;
            }
        }
