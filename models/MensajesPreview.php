 ...
 * Page class
 */
class MensajesPreview extends Mensajes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MensajesPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "tareas") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=tareas&" . GetForeignKeyUrl("fk_id_tarea", $this->id_tareas->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "tareas") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_tareas->setQueryStringValue($val);
            }
        }
    }
    ...
    public function listOptionsRendered()
    {
      ...
      //  $this->ListOptions->Items["details"]->Body .= "(" . $this->YourDetailmensajes_Count . ")";
    }
}
