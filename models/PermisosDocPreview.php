 ...
 * Page class
 */
class PermisosDocPreview extends PermisosDoc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "archivos_doc") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=archivos_doc&" . GetForeignKeyUrl("fk_id_file", $this->id_file->QueryStringValue) . "";
        }
        return $url;
    }
        ...
        if ($masterTblVar == "archivos_doc") {
            ...
            if ($x !== false) {
                ...
                $val = $this->unquoteValue($val, "DB");
                 $this->id_file->setQueryStringValue($val);
            }
        }
    }
