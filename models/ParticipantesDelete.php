 ...
 * Page class
 */
class ParticipantesDelete extends Participantes
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ParticipantesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ParticipantesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ParticipantesList"); // Return to list
                return;
            }
        }
