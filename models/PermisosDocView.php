 ...
 * Page class
 */
class PermisosDocView extends PermisosDoc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_permiso") ?? Route("id_permiso")) !== null) {
            $this->RecKey["id_permiso"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_permiso") ?? Route("id_permiso")) !== null) {
                ...
                $this->RecKey["id_permiso"] = $this->id_permiso->QueryStringValue;
            } elseif (Post("id_permiso") !== null) {
                $this->id_permiso->setFormValue(Post("id_permiso"));
                $this->RecKey["id_permiso"] = $this->id_permiso->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_permiso->setQueryStringValue($keyValue);
                $this->RecKey["id_permiso"] = $this->id_permiso->QueryStringValue;
            } else {
                $returnUrl = "PermisosDocList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PermisosDocList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PermisosDocList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
