 ...
 * Page class
 */
class PermisosDocDelete extends PermisosDoc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PermisosDocDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PermisosDocList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PermisosDocList"); // Return to list
                return;
            }
        }
